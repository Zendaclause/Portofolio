                ...
                <div class="modal-body">
                  ...
                  <form action="../config.php" method="post">
                          ...
                          <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group">
                                ...
                                <input name="username" type="text" id="input-first-name" class="form-control" placeholder="Username">
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="input-last-name">Password</label>
                                <input name="password" type="password" id="input-last-name" class="form-control" placeholder="Password">
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input name="jalan" type="text" class="form-control" placeholder="Jalan">
                          </div>
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label class="form-control-label" for="input-first-name">Kelurahan</label>
                            <input name="kelurahan" type="text" id="input-first-name" class="form-control" placeholder="Kelurahan">
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label class="form-control-label" for="input-last-name">Kecamatan</label>
                            <input name="kecamatan" type="password" id="input-last-name" class="form-control" placeholder="Kecamatan">
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label class="form-control-label" for="input-last-name">Kode POS</label>
                            <input name="kodepos" type="password" id="input-last-name" class="form-control" placeholder="Kode POS">
                          </div>
                        </div>
                      </div>
