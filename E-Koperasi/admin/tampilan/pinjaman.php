                ...
                <div class="modal-body">
                  ...
                  <form>
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" placeholder="Jumlah Pinjaman">
                          </div>
                          ...
                          <div class="form-group">
                              <label for="nama">Lama Cicilan</label>
                              <select class="form-control" id="cicilan" name="Cicilan">
                                <option value="volvo">12 Bulan</option>
                                <option value="saab">24 Bulan</option>
                                <option value="fiat">36 Bulan</option>
                              </select>
                          </div>

                          <div class="form-group">
                              <label for="nama">Angsuran</label>
                              <input type="text" class="form-control" placeholder="Angsuran">
                          </div>

                          <div class="form-group">
                              <label for="nama">Tanggal Jatuh Tempo</label>
                              <input type="date" class="form-control" id="start" name="trip-start" value="2022-01-01" min="2022-01-01">
                          </div>
